...
class UserLoginForm(forms.Form):
    """Форма входа пользователя в свой профиль. Включает поля e-mail,
       пароль."""
...
class UserRegistrationForm(forms.ModelForm):
    """Форма регистрации пользователя. Включает поля e-mail,
...
class UserUpdateForm(forms.Form):
    """Форма для внесения изменений в настройки пользователя.
    Включает поля город, язык и чекбокс для подтверждения получения рассылки."""
...
class ContactForm(forms.Form):
    """Форма для информирования админа пользователем. Включает поля
    город, язык, e-mail."""
